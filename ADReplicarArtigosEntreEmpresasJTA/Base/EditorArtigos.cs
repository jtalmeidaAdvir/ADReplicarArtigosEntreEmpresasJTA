    ...
    public class EditorArtigos : FichaArtigos
    {
            public override void DepoisDeGravar(string Artigo, ExtensibilityEventArgs e)
            {
                try
                {
                    ...
                    double pVP = val.PVP1;
                    double pVP2 = val.PVP2;
                    double pVP3 = val.PVP3;
                    double pVP4 = val.PVP4;
                    double pVP5 = val.PVP5;
                    double pVP6 = val.PVP6;
